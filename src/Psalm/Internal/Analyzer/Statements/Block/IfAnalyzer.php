...
class IfAnalyzer
{
    ...
    private static function analyzeIfConditional(
        ...
        $if_conditional_context->parent_context = $if_context;

        if ($codebase->alter_code) {
            $if_conditional_context->branch_point = $branch_point;
        }
